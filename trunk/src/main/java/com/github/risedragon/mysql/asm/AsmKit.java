...
import static com.github.risedragon.mysql.asm.JdbcActionClassLoader.Loader;
...
import com.github.risedragon.mysql.annotation.Column;
import com.github.risedragon.mysql.annotation.ForeignKey;
import com.github.risedragon.mysql.annotation.Indexes;
import com.github.risedragon.mysql.annotation.Meta;
import com.github.risedragon.mysql.annotation.OptimisticLock;
import com.github.risedragon.mysql.annotation.PrimaryKey;
import com.github.risedragon.mysql.annotation.Table;
...
public final class AsmKit {
	...
	public static JdbcAction newJdbcAction(String targetClassName) throws IOException, ReflectiveOperationException {
		String className = targetClassName + "$SqlAction";
		Class<?> c = null;
		try {
			c = Loader.loadClass(className);
		} catch (ClassNotFoundException e) {
